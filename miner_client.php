 ...
 * 10 = 4 * 8
 */
$fetchcount = (int)(floor(count($apikeys) / 2) - 1) * 8;
...
$timestamp = time();
$errordata = array("log" => "Start fetching $fetchcount stations from $filepath my current time is $timestamp", "evanr" => 100);
...
$errordata = array("log" => "Finished fetching $fetchcount stations from $filepath", "evanr" => 100);
$db->insert("errorlog2", $errordata);
